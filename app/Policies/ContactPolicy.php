...
class ContactPolicy
{
    ...
    {
      return $user->id == $contact->user_id || $user->id == $contact->other_user_id;
    }
     ...
     * @return mixed
     */
    // public function unBlock(User $user, Contact $contact)
    // {
    //   return $user->id == $contact->blocker()->first()->id ?? false;
    // }
}
