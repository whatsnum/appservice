...
class CreateInterestsTable extends Migration
{
    ...
    public function createData(){
      $interests = [
        'Writing/Blogging','Catering/Baking','Music','Wine','Bi-Sexuals' ,'Threesome','Partying','Night Clubs','Business','Fun' ,'Investing','Business' ,'Love making','Sex partner','New relationship','Dating','Lesbian Dating','Gay Dating','Meeting New people','Public Speaking','Programming/Coding','Drive Others Around' ,'Fitness','Decorating Homes',
